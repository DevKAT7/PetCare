...
namespace PetCare.Api.Controllers
{
    ...
    public class StockItemsController : ControllerBase
    {
        ...
        {
            var query = new GetStockItemQuery { Id = id };
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] StockItemUpdateModel request)
        {
            var command = new UpdateStockItemCommand(id, request);
        ...
        {
            var command = new DeleteStockItemCommand(id);
