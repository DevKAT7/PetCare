...
{
    public class GetAllVetsHandler : IRequestHandler<GetAllVetsQuery, List<VetDto>>
    {
        ...
        public async Task<List<VetDto>> Handle(GetAllVetsQuery request, CancellationToken cancellationToken)
        {
